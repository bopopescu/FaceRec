...
from src.main.FaceRec.architecture import inception_resnet_v1 as resnet
import numpy as np

class FaceFeature(object):
    def __init__(self, face_rec_graph, model_path = 'C:/Users/birsa/FaceRec/FaceRec/models/model-20170512-110547.ckpt-250000'):
        '''
